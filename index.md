...
email: ["ksoenen@whoi.edu","adyork@whoi.edu", "stace@whoi.edu", "areed@whoi.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
