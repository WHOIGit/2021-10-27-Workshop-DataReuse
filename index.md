...
humandate: "October 27, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Amber York", "Stace Beaulieu", "Andrew Reed", "Emma Ozanich", "Ariel Vardi-Chouchana" ]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["ksoenen@whoi.edu","adyork@whoi.edu", "stace@whoi.edu", "areed@whoi.edu", "arvardi@whoi.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
